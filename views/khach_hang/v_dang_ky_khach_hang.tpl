                    ...
                    <table class="table " cellpadding="10px"  align="center" style="border-collapse: collapse;">
                        <tr>
                            <td align="center">
                                ...
                                <br>
                                <input type="text" name="ho_ten" id="ho_ten" value="{$smarty.session.ho_ten}" style="text-align: center;width:300px;height:35px" autofocus>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <br>
                                <input type="text" name="so_dien_thoai" value="{$smarty.session.so_dien_thoai}" id="so_dien_thoai" style="text-align: center;width:300px;height:35px">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <br>
                                <input type="text" name="dia_chi" id="dia_chi" value="{$smarty.session.dia_chi}" style="text-align: center;width:300px;height:35px">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td align="center"> 
                                Email
                                <br>
                                <input type="email" name="email" id="email" value="{$smarty.session.email}" style="text-align: center;width:300px;height:35px" placeholder="Dùng đăng nhập cho lần mua kế tiếp">
                            </td>
