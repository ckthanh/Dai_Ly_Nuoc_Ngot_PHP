                            ...
                            <form action="#" method="post" class="form-horizontal"   enctype="multipart/form-data" >
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="ma_loai_nuoc_uong" name="ma_loai_nuoc_uong" class="form-control col-md-7 col-xs-12" type="text" disabled  value="{$dslnutm->ma_loai_nuoc_uong}">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input type="text" name="ten_loai_nuoc_uong" id="ten_loai_nuoc_uong" class="form-control col-md-7 col-xs-12" value="{$dslnutm->ten_loai_nuoc_uong}">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input type="text" name="mo_ta" id="mo_ta" class="form-control col-md-7 col-xs-12" value="{$dslnutm->mo_ta}">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        {if $dslnutm->hinh !=""}
                                             <img src="../public/images/hinh_loai_nuoc_uong/{$dslnutm->hinh}" alt="" style="width:200px;height:100px">
                                        {/if}
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                       <input type="text" name="trang_thai" id="trang_thai" class="form-control col-md-7 col-xs-12" value="{$dslnutm->trang_thai}">
                                    </div>
                                </div>
